...
void test_default_calibration_maps_values_linearly_between_axis_limits()
{
  ...
  TEST_ASSERT_EQUAL_UINT16(342U, result.joint_pwm_state.d_pwm);
  TEST_ASSERT_EQUAL_UINT16(308U, result.joint_pwm_state.s_pwm);
  TEST_ASSERT_EQUAL_UINT16(308U, result.joint_pwm_state.e_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMinPulsePwm, result.joint_pwm_state.hp_pwm);
  TEST_ASSERT_EQUAL_UINT16(308U, result.joint_pwm_state.hr_pwm);
}
...
void test_default_calibration_maps_axis_limits_to_pwm_limits()
{
  ...
  TEST_ASSERT_TRUE(result.ok);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMinPulsePwm, result.joint_pwm_state.d_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMinPulsePwm, result.joint_pwm_state.s_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMaxPulsePwm, result.joint_pwm_state.e_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMaxPulsePwm, result.joint_pwm_state.hp_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMaxPulsePwm, result.joint_pwm_state.hr_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMinPulsePwm, result.joint_pwm_state.g_pwm);
}
...
void test_default_calibration_clamps_values_before_mapping()
{
  ...
  TEST_ASSERT_TRUE(result.ok);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMinPulsePwm, result.joint_pwm_state.d_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMaxPulsePwm, result.joint_pwm_state.s_pwm);
  TEST_ASSERT_EQUAL_UINT16(308U, result.joint_pwm_state.e_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMaxPulsePwm, result.joint_pwm_state.hp_pwm);
  TEST_ASSERT_EQUAL_UINT16(308U, result.joint_pwm_state.hr_pwm);
  TEST_ASSERT_EQUAL_UINT16(common::kServoMaxPulsePwm, result.joint_pwm_state.g_pwm);
}

void test_calibration_can_map_in_descending_pwm_order()
{
  auto calibration = hardware::defaultHardwareCalibration();
  calibration.s.min_pwm = common::kServoMaxPulsePwm;
  calibration.s.max_pwm = common::kServoMinPulsePwm;

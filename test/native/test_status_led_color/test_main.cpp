...
void test_status_led_color_maps_off_to_zero_arguments() {
  const auto color =
      hardware::toNeopixelWriteColor(hardware::StatusColor::Off, 255);
...
void test_status_led_color_maps_red_for_grb_led_order() {
  const auto color =
      hardware::toNeopixelWriteColor(hardware::StatusColor::Red, 64);
...
void test_status_led_color_maps_orange_for_grb_led_order() {
  const auto color =
      hardware::toNeopixelWriteColor(hardware::StatusColor::Orange, 100);
...
void test_status_led_color_maps_yellow_for_grb_led_order() {
  const auto color =
      hardware::toNeopixelWriteColor(hardware::StatusColor::Yellow, 100);
...
void test_status_led_color_maps_green_for_grb_led_order() {
  const auto color =
      hardware::toNeopixelWriteColor(hardware::StatusColor::Green, 128);
...
void test_status_led_color_maps_cyan_for_grb_led_order() {
  const auto color =
      hardware::toNeopixelWriteColor(hardware::StatusColor::Cyan, 150);
...
void test_status_led_color_maps_blue_without_channel_swap() {
  const auto color =
      hardware::toNeopixelWriteColor(hardware::StatusColor::Blue, 200);
...
void test_status_led_color_maps_violet_for_grb_led_order() {
  const auto color =
      hardware::toNeopixelWriteColor(hardware::StatusColor::Violet, 220);

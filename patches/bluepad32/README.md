...
`scripts/bootstrap.sh` initialisiert das Submodule und wendet die Patches idempotent an. Die oberste `CMakeLists.txt` bindet die gepatchte Komponente direkt aus dem Submodule über `EXTRA_COMPONENT_DIRS` in den ESP-IDF-Build ein.
